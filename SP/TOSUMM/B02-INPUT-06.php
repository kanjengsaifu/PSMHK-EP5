...
$tampil = mysqli_query($con, "SELECT * FROM spub WHERE tanggal = $tanggal-1 and nama_tangki = 'TOS-UMM'") or die (mysqli_error());
...
<head>
    ...
    <title>Monitoring Production TOS UMM</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="">INPUT TOS UMM pada 06.00</a></li>
...
<div class="container">
  ...
  return confirm('Stock SP TOSS-UMM @06.00 : '+hasil);">Submit</button>
</form>    
  </div>
 <br>
 <br>
