...
$tampil = mysqli_query($con, "SELECT * FROM spub WHERE tanggal = $tanggal and nama_tangki = 'TOS-UMM'") or die (mysqli_error());
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="">INPUT TOS UMM pada 12.00</a></li>
...
<div class="container">
  ...
  return confirm('Stock SP TOSS-UMM @12.00 : '+hasil);">Submit</button>
</form>  
</div> 
<hr>
</div>
