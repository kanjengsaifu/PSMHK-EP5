...
$tampil = mysql_query("SELECT * FROM spub WHERE tanggal = $tanggal and nama_tangki = 'B-1'") or die (mysql_error());
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="">INPUT B 1 pada 24.00</a></li>
...
<div class="container">
 ...
 <div class="container">
  ...
  return confirm('Stock SP B-1 @24.00 : '+hasil);">Submit</button>
</form>  
 </div>
 <hr> 
</div>
