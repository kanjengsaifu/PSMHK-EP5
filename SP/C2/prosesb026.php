...
$tampil = mysql_query("SELECT * FROM spub WHERE tanggal = $tanggal-1 and nama_tangki = 'C-2'") or die (mysql_error());
$data = mysql_fetch_array($tampil);

$cek = mysql_query("SELECT * FROM spub WHERE tanggal = $tanggal and nama_tangki = 'C-2'") or die (mysql_error());
