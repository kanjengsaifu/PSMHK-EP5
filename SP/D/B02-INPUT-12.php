...
$tampil = mysql_query("SELECT * FROM spub WHERE tanggal = $tanggal and nama_tangki = 'D'") or die (mysql_error());
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="">INPUT D pada 12.00</a></li>
...
<div class="container">
  ...
  return confirm('Stock SP D @12.00 : '+hasil);">Submit</button>
</form>  
</div> 
<hr>
</div>
