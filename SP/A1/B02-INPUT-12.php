...
$tampil = mysqli_query($con, "SELECT * FROM spub WHERE tanggal = $tanggal and nama_tangki = 'A-1'") or die (mysqli_error());
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="">INPUT A 1 pada 12.00</a></li>
...
<div class="container">
  ...
  return confirm('Stock SP A-1 @12.00 : '+hasil);">Submit</button>
</form>  
</div> 
<hr>
</div>
