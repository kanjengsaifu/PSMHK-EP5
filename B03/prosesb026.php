...
$cek = mysqli_query($con, "SELECT * FROM spub WHERE tanggal = $tanggal and nama_tangki='B-03'") or die (mysqli_error());
...
if (isset($_POST)) {
	...
	if ($cekin['six']== 0 or $cekin['six'] ==null) {
    	$sql = "INSERT INTO spub (tanggal, zero, six, nama_tangki) values ('$tanggal','$data[twentyfour]', '$_POST[b026]','B-03' )";	
	} else {
    	$sql = "update spub set six='$_POST[b026]' where tanggal = $tanggal and nama_tangki='B-03'";
	}
