...
$tampil = mysqli_query($con, "SELECT * FROM spub WHERE tanggal = $tanggal-1 and nama_tangki = 'B-04'") or die (mysqli_error());
...
<head>
    ...
    <title>Monitoring Production B 04</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="">INPUT B 04 pada 06.00</a></li>
      <li><a href="B04.php"><< PILIH WAKTU</a></li>
    </ul> 
  </div>
</nav>
<div class="container">
  ...
  return confirm('Stock B-04 @06.00 : '+hasil);">Submit</button>
</form>    
  </div>
 <br>
 <br>
