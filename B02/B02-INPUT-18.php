...
$tampil = mysqli_query($con, "SELECT * FROM spub WHERE tanggal = '$tanggal' and nama_tangki = 'B-02'") or die (mysqli_error());
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="">INPUT B 02 pada 18.00</a></li>
...
<div class="container">
 ...
 <form class="form-inline" action="prosesb0218.php" method="post" style="text-align: center">
  ...
  return confirm('Stock B-02 @18.00 : '+hasil);">Submit</button>
</form>   
  </div>
  <hr> 
</div>
