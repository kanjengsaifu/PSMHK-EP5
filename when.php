<?php 
    ...
    $datas=0;
    if (isset($_POST)) {
      $date=date_create($_POST['b026']);
    }
    else{
         $date=date_create(date('Y-m-d'));  
    }
    //$nanti = $sekarang->format('Y-m-d');
    $sekarang=date_format($date,'Y-m-d');
    $tanggalan = date_format($date,'d-m-Y'); 
?>
<html>
<head>
    <meta charset="utf-8">
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="">TABEL INVENTORY 7055 PADA <?php echo $tanggalan ?></a></li>
      <li><a href="index.php"><< Home</a></li>
    </ul> 
  </div>
</nav>
<h1 class="text-center"> TABEL INVENTORY 7055 : <?php echo $tanggalan;?> </h1>
    <hr>
            <form class="form-inline" action="when.php" method="post" style="text-align: center">  
                    <div class="form-group"> 
                        <label for="date"> Tanggal Produksi </label>
                        <input type="date" class="form-control" id="b026" name="b026" required>
